...
namespace ProductionManagement.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260902091104_CR01IntradayProductionEntries")]
    partial class CR01IntradayProductionEntries
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("system_settings", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_system_settings_time_range", "day_end_time > day_start_time");
                        });
                });
